...
void MatrixMulElement2X2(vector<int> matrix_U, vector<int> matrix_V, vector<int>& matrix_M, int U_rows, int UcolsVrows, int V_cols)
{
...
void MatrixMulElement4X4(vector<int> matrix_U, vector<int> matrix_V, vector<int>& matrix_M, int U_rows, int UcolsVrows, int V_cols)
{
	...
	for (int i = 0; i < U_rows / 4; ++i) { // 행
		...
		for (int j = 0; j < V_cols / 4; ++j) // 열 
		{
			...
			{
				m1 += matrix_U[i * UcolsVrows * 4 + k * 4] * matrix_V[k * V_cols * 4 + j * 4];
				m2 += matrix_U[i * UcolsVrows * 4 + k * 4 + 1] * matrix_V[k * V_cols * 4 + j * 4 + 1];
				m3 += matrix_U[i * UcolsVrows * 4 + k * 4 + 2] * matrix_V[k * V_cols * 4 + j * 4 + 2];
				m4 += matrix_U[i * UcolsVrows * 4 + k * 4 + 3] * matrix_V[k * V_cols * 4 + j * 4 + 3];

				m5 += matrix_U[i * UcolsVrows * 4 + k * 4 + UcolsVrows] * matrix_V[k * V_cols * 4 + j * 4 + V_cols];
				m6 += matrix_U[i * UcolsVrows * 4 + k * 4 + 1 + UcolsVrows] * matrix_V[k * V_cols * 4 + j * 4 + 1 + V_cols];
				m7 += matrix_U[i * UcolsVrows * 4 + k * 4 + 2 + UcolsVrows] * matrix_V[k * V_cols * 4 + j * 4 + 2 + V_cols];
				m8 += matrix_U[i * UcolsVrows * 4 + k * 4 + 3 + UcolsVrows] * matrix_V[k * V_cols * 4 + j * 4 + 3 + V_cols];

				m9 += matrix_U[i * UcolsVrows * 4 + k * 4 + UcolsVrows * 2] * matrix_V[k * V_cols * 4 + j * 4 + V_cols*2];
				m10 += matrix_U[i * UcolsVrows * 4 + k * 4 + 1 + UcolsVrows * 2] * matrix_V[k * V_cols * 4 + j * 4 + 1 + V_cols * 2];
				m11 += matrix_U[i * UcolsVrows * 4 + k * 4 + 2 + UcolsVrows * 2] * matrix_V[k * V_cols * 4 + j * 4 + 2 + V_cols * 2];
				m12 += matrix_U[i * UcolsVrows * 4 + k * 4 + 3 + UcolsVrows * 2] * matrix_V[k * V_cols * 4 + j * 4 + 3 + V_cols * 2];

				m13 += matrix_U[i * UcolsVrows * 4 + k * 4 + UcolsVrows * 3] * matrix_V[k * V_cols * 4 + j * 4 + V_cols * 3];
				m14 += matrix_U[i * UcolsVrows * 4 + k * 4 + 1 + UcolsVrows * 3] * matrix_V[k * V_cols * 4 + j * 4 + 1 + V_cols * 3];
				m15 += matrix_U[i * UcolsVrows * 4 + k * 4 + 2 + UcolsVrows * 3] * matrix_V[k * V_cols * 4 + j * 4 + 2 + V_cols * 3];
				m16 += matrix_U[i * UcolsVrows * 4 + k * 4 + 3 + UcolsVrows * 3] * matrix_V[k * V_cols * 4 + j * 4 + 3 + V_cols * 3];

			}
			matrix_M[i * V_cols * 4 + j * 4] = m1;
			matrix_M[i * V_cols * 4 + j * 4 + 1] = m2;
			matrix_M[i * V_cols * 4 + j * 4 + 2] = m3;
			matrix_M[i * V_cols * 4 + j * 4 + 3] = m4;

			matrix_M[i * V_cols * 4 + j * 4 + V_cols] = m5;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols + 1] = m6;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols + 2] = m7;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols + 3] = m8;

			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 2] = m9;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 2 + 1] = m10;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 2 + 2] = m11;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 2 + 3] = m12;

			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 3] = m13;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 3 + 1] = m14;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 3 + 2] = m15;
			matrix_M[i * V_cols * 4 + j * 4 + V_cols * 3 + 3] = m16;
